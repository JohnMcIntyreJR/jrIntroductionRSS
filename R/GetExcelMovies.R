...
#'
#' This function will attempt to create a local copy of the movies data set such
#' that you can make sure that you are happy with reading in data from Excel
#' files.
#'
